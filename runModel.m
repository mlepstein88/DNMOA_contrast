function [perfv, p, ev] = runModel(opt, modelClass, rsoa, rseq, rcond, rcontrasts)
...
rcontrast = contrasts; % contrast levels to run
    ...
    for icontrast = 1:ncontrast
        ...
        for isoa = 1:nsoa
            ...
            for iseq = 1:nseq
                ...
                p.cond = cond;
                p.condname = condname;
                p.contrast = contrasts(:,icontrast);
                p.soa = soas(:,s);
...
if plotPerf
    for icontrast = 1:4%numel(rcontrast)
